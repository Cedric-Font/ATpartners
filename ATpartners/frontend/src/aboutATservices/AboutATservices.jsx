    ...
    <NavMobile />
      ...
      <section className={styles.bodyContainer}>
        <div className={styles.objectif}>
          ...
          <p className={styles.objectifText}>Les objectifs de développement ont été atteints chaque
            ...
            panneaux et menuiseries isothermes. Pour les prochaines années, nos
            objectifs sont de:</p>
        </div>
